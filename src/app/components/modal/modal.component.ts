...
import { ANIMAIS_CL, CENTRO_CUSTO_CL, GRUPO_CENTRO_CL } from '../constants/constants';
...
export class ModalComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.data.metodoConcepcao? this.parto.metodoConcepcao = this.data.metodoConcepcao: '';
        this.dose = this.data.dose ? this.data.dose : new DoseSemen();
        this.dose.dadosInseminacao? '': this.dose.dadosInseminacao = {       
            egua: null,
            registroEgua: null,
