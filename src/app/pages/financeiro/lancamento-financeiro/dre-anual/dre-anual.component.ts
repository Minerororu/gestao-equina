...
export class DreAnualComponent implements OnInit {
  ...
  filtrar() {
    this.lancamentos = this.lancamentos.filter((lancamento) => {
      let ano =
        lancamento.data.charAt(6) +
        lancamento.data.charAt(7) +
        lancamento.data.charAt(8) +
        lancamento.data.charAt(9);
      return ano == this.ano;
    });
    this.calcularTabela();
  }
  ...
  calcularTabela() {
    this.lancamentosFiltrados.map((lancamento) => {
      ...
      switch (lancamento.data.charAt(3) + lancamento.data.charAt(4)) {
        case '01':
          lancamento.valoresPorMeses[0] += lancamento.valorDocumento;
          break;
        case '02':
          lancamento.valoresPorMeses[1] += lancamento.valorDocumento;
          break;
        case '03':
          lancamento.valoresPorMeses[2] += lancamento.valorDocumento;
          break;
        case '04':
          lancamento.valoresPorMeses[3] += lancamento.valorDocumento;
          break;
        case '05':
          lancamento.valoresPorMeses[4] += lancamento.valorDocumento;
          break;
        case '06':
          lancamento.valoresPorMeses[5] += lancamento.valorDocumento;
          break;
        case '07':
          lancamento.valoresPorMeses[6] += lancamento.valorDocumento;
          break;
        case '08':
          lancamento.valoresPorMeses[7] += lancamento.valorDocumento;
          break;
        case '09':
          lancamento.valoresPorMeses[8] += lancamento.valorDocumento;
          break;
        case '10':
          lancamento.valoresPorMeses[9] += lancamento.valorDocumento;
          break;
        case '11':
          lancamento.valoresPorMeses[10] += lancamento.valorDocumento;
          break;
        case '12':
          lancamento.valoresPorMeses[11] += lancamento.valorDocumento;
          break;
      }
      ...
      if (
        ...
        this.objsDaTabela.push({
          centroCusto: lancamento.centroDeCusto.nome,
          valoresMeses: lancamento.valoresPorMeses,
        });
      } else {
        var index = this.objsDaTabela
          .map(function (e) {
        ...
        for (let i = 0; i < this.objsDaTabela[index].valoresMeses.length; i++) {
          if (
            i + 1 ==
            parseInt(lancamento.data.charAt(3) + lancamento.data.charAt(4))
          ) {
            this.objsDaTabela[index].valoresMeses[i] +=
              lancamento.valorDocumento;
          }
        }
      }
    });
