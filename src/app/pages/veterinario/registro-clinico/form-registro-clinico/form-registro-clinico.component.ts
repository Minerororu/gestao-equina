...
export class FormRegistroClinicoComponent implements OnInit {
  ...
  doencas = [
    'Anemia Infecciosa', 'Arterite Viral Equina', 'Diarreia', 'Durina', 'Encefalomielite', 'Influenza Equina', 'Metrite Contagiosa Equina', 'Mormo', 'Peste Equina', 'Piroplasmose', 'Raquitismo', 'Rinopneumonite', 'Sarnas - acarioses', 'Surra(Trypanosoma evansi)', 'Verminoses - helmintíases'
  ]
  situacoes = [
    'Em Tratamento', 'Concluido', 'Interrompido', 'Cancelado'
  ]
  constructor(private service: RegistroClinicoService, private router: Router) { }

  ngOnInit(): void {
    this.registro = this.service.registroClinico ? this.service.registroClinico: new RegistroClinico()
  }
